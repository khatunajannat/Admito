        ...
        <div className="grid pt-8 text-left border-t border-slate-300 md:grid-cols-3 md:gap-12">
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-[#805827]/10 lg:h-12 lg:w-12">
              <svg className="w-5 h-5 text-[#805827] lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" d="M3 8l9-5 9 5-9 5-9-5zm0 0v8l9 5 9-5V8" />
              </svg>
            </div>
            <h3 className="mb-2 text-xl font-semibold text-slate-800">Recent Circulars</h3>
            <p className="text-slate-500">
              Stay on top of every notice the admission office publishes, from merit lists to document deadlines, the moment they go live.
            </p>
            <Link to="/circulars" className="inline-flex items-center mt-3 text-sm font-medium text-[#805827] hover:text-[#FFD700]">
          {/* Recent Circulars */}
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-[#805827]/10 lg:h-12 lg:w-12">
              <svg
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-semibold text-slate-800">Application Status</h3>
            <p className="text-slate-500">
              Enter your application ID and see exactly where you stand — submitted, under review, or admitted — without waiting on an email.
            </p>
            <Link to="/status" className="inline-flex items-center mt-3 text-sm font-medium text-[#805827] hover:text-[#FFD700]">
              <svg
                className="w-5 h-5 text-[#805827] lg:w-6 lg:h-6"
                fill="none"
                stroke="currentColor"
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-semibold text-slate-800">Important Dates</h3>
            <p className="text-slate-500">
              Applications close, exams sit, and merit lists drop on fixed dates. Keep the full admission calendar one tap away.
            </p>
            <Link to="/important-dates" className="inline-flex items-center mt-3 text-sm font-medium text-[#805827] hover:text-[#FFD700]">
              <svg
                className="w-5 h-5 text-[#805827] lg:w-6 lg:h-6"
                fill="none"
                stroke="currentColor"
